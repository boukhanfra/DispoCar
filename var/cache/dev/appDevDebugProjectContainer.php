...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'Localhost', 'port' => 3306, 'dbname' => 'bookingcar', 'user' => 'root', 'password' => 'soundous', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/parcAutoBundle/Entity'), 1 => ($this->targetDirs[3].'/src/AgenceBundle/Entity'), 2 => ($this->targetDirs[3].'/src/ReservationBundle/Entity'), 3 => ($this->targetDirs[3].'/src/AbonnementBundle/Entity'), 4 => ($this->targetDirs[3].'/src/IndexBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'parcAutoBundle\\Entity');
        $c->addDriver($b, 'AgenceBundle\\Entity');
        $c->addDriver($b, 'ReservationBundle\\Entity');
        $c->addDriver($b, 'AbonnementBundle\\Entity');
        $c->addDriver($b, 'IndexBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('parcAutoBundle' => 'parcAutoBundle\\Entity', 'AgenceBundle' => 'AgenceBundle\\Entity', 'ReservationBundle' => 'ReservationBundle\\Entity', 'AbonnementBundle' => 'AbonnementBundle\\Entity', 'IndexBundle' => 'IndexBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_072278c86ff8c26880f92e52bdf295325a8f83ef4bbdbba2dc79d7c62ade2496');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('admin@gsmlot.com');
        $a->setPassword('Redondo92015');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/parcAutoBundle/Resources/views'), 'parcAuto');
        $instance->addPath(($this->targetDirs[3].'/src/AgenceBundle/Resources/views'), 'Agence');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('736922ef9b84163e6b17f1d94eb518ca228229ba');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56ddfef9cf57e0.99075407')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'parcAutoBundle' => 'parcAutoBundle\\parcAutoBundle',
                'AgenceBundle' => 'AgenceBundle\\AgenceBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'bookingcar',
            'database_user' => 'root',
            'database_password' => 'soundous',
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtpout.secureserver.net',
            'mailer_user' => 'admin@gsmlot.com',
            'mailer_password' => 'Redondo92015',
            'secret' => '736922ef9b84163e6b17f1d94eb518ca228229ba',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '736922ef9b84163e6b17f1d94eb518ca228229ba',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtpout.secureserver.net',
            'swiftmailer.mailer.default.transport.smtp.username' => 'admin@gsmlot.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Redondo92015',
