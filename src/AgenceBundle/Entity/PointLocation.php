 ...
 * @ORM\Entity(repositoryClass="AgenceBundle\Repository\PointLocationRepository")
 */
class PointLocation
{
    /**
     ...
     * Set idPointLocation
     *
     * @param integer $idPointLocation
     *
     * @return PointLocation
     */
    public function setIdPointLocation($idPointLocation)
    {
